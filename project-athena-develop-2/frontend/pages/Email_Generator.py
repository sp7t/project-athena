...
if "last_candidate" not in st.session_state or st.session_state.last_candidate != selected_name:
...
if st.session_state.verdict == "No":
    st.session_state.rejection_reason = st.selectbox("Rejection Reason", [
...
if st.session_state.email_body:
    ...
    st.session_state.email_body = st.text_area("Edit Email:", value=st.session_state.email_body, height=300)
